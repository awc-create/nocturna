...
CREATE TABLE "FaqPage" (
    ...
    "lead" TEXT NOT NULL DEFAULT 'A quick guide for venues, events and artists working with Nocturna. If you can’t find what you’re looking for, just get in touch.',
